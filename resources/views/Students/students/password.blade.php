...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">Change {{ $student->first_name }} {{ $student->last_name }} password</div>
                    <div class="card-body">
                        <form class="form-horizontal" action="/student-Int-edit/{{$student->id}}/password" method="POST" id="editPassword">
                            @csrf
